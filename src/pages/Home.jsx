  ...
  return (
    <>
      <div className="w-full mt-20 bg-cover bg-center md:h-[90vh] h-full flex items-center justify-center" style={{backgroundImage: `url(${banner1})`}}>
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className='max-w-7xl mx-auto md:w-full sm:w-[470px] w-96 flex flex-col px-5 py-10 md:py-0 items-center sm:gap-5 gap-3'>
          <motion.h1 variants={childVariants} className='md:text-5xl text-4xl text-white text-center'>Make HR Process Quick, Easy and Simple.</motion.h1>
          <motion.p variants={childVariants} className='sm:text-2xl text-lg text-white md:mb-10 mb-5 text-center'>HR Software for companies where people matter</motion.p>
