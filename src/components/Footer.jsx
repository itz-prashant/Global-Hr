  ...
  return (
    <>
      <footer className='bg-[#292e31] w-full'>
        ...
        <div className='bg-[#292e31] grid grid-cols-1 max-w-7xl w-96 sm:w-[430px] md:w-full mx-auto md:grid-cols-2 lg:grid-cols-4 md:p-10 p-5 mt-20'>
          ...
          <div className='flex flex-col gap-6 p-8'>
              ...
              <FreeTrailForm labelName="Name" labelEmail="Email Address" labelCompanyName="Company Name" background="blue"  direction="col" transparent="transparent"/>
          </div>
